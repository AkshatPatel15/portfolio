...
const Certidict = [
    ...
    {
        certilogo:<FontAwesomeIcon icon={faLinkedinIn} size="3x"/>,
        certilabel:"Business Analysis",
        certidetail:"this is the detail of the certificate",
        certilink:"https://www.linkedin.com/learning/certificates/341492a2feac2424c4baad7e91cf11cc9804ca29cb76abc11dda718ef0567a42",
    },
    {
        certilogo:<FontAwesomeIcon icon={faLinkedinIn} size="3x"/>,
        certilabel:"Figma",
